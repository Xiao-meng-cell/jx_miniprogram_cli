// miniprogram/pages/tabBar_user_center/business_card_manage/business_card_show/business_card_show.js
...
Page({
  ...
  onShareAppMessage: function (e) {
    ...
    if (e.from === 'button') {
      ...
      return {
        ...
        path: "pages/clerk/show/show?shareId=" + this.data.shareId + "&higherLevelCode=" + this.data.clerk_code + "&workerId=" + this.data.workerId + "&merchantCode=" + this.data.merchant_code,
        imageUrl: "",
        success: res => {},
        fail: res => {}
      }
  ...
  jumpBusiness: function () {
    wx.navigateTo({
      url: '/pages/tabBar_index/business_homepage/business_homepage?merchantCode=' + this.data.merchant_code + '&higherLevelCode=' + app.globalData.higherLevelCode + '&cover=' + this.data.card_phone,
    })
  },
  ...
  goToDetail: function (e) {
    wx.navigateTo({
      url: '/pages/tabBar_index/business_detail/business_detail?code=' + e.currentTarget.dataset.code + '&higherLevelCode=' + app.globalData.higherLevelCode + "&activityType=" + e.currentTarget.dataset.activitytype + "&clerk_code=" + this.data.clerk_code,
    })
  },
